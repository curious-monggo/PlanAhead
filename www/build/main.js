...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_detail_detail__ = __webpack_require__(267);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_course_course__ = __webpack_require__(268);
...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, courseProvider) {
    ...
    HomePage.prototype.navigateToDetailPage = function (id) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__pages_detail_detail__["a" /* DetailPage */], {
            id: id
        });
    ...
    HomePage.prototype.test = function (name) {
        console.log(name);
    };
    HomePage.prototype.getCourses = function () {
        var _this = this;
        this.courseProvider.getCourses().subscribe(function (c) {
            _this.courses = c;
    ...
    HomePage.prototype.onSubmitAdd = function () {
        this.courseProvider.addCourse(this.course);
        /*this.courseProvider.addCourse({name:value});*/
    };
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Users\Kuya\Projects\planAhead\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Ionic Blank\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n	<ion-card>\n		<ion-card-header>\n		    Insert course to Firebase\n		</ion-card-header>\n		<ion-card-content>\n<!-- 			<form (ngSubmit)="onSubmitAdd()">\n		      <ion-item>\n		        <ion-label>Todo</ion-label>\n		        <ion-input type="text" [(ngModel)]="todo.title" name="title"></ion-input>\n		      </ion-item>\n		      <ion-item>\n		        <ion-label>Description</ion-label>\n		        <ion-textarea [(ngModel)]="todo.description" name="description"></ion-textarea>\n		      </ion-item>\n		      <button ion-button type="submit" block>Add Todo</button>\n			</form> -->\n			<form (ngSubmit)="onSubmitAdd()">\n				<ion-input [(ngModel)]="course.name" name="name" type="text" placeholder="Course name"></ion-input>\n				<button ion-button type="submit">Add</button>\n				<!-- <button ion-button (click)="getCourses()">List</button>		 -->\n			</form>\n\n		</ion-card-content>\n	</ion-card>\n		<ion-list>\n			<ion-card \n			*ngFor="let course of courses" \n			(click)="navigateToDetailPage(course.key)"\n			[navPush]="pushToDetailPage" [navParams]="paramsID">\n				<ion-card-header>\n					<b>{{course.key}}</b>\n				</ion-card-header>\n				<ion-card-content>\n					<p>{{course.name}}</p>\n				</ion-card-content>\n			</ion-card>\n		</ion-list>\n</ion-content>\n'/*ion-inline-end:"C:\Users\Kuya\Projects\planAhead\src\pages\home\home.html"*/
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__providers_course_course__["a" /* CourseProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__providers_course_course__["a" /* CourseProvider */]) === "function" && _b || Object])
    ], HomePage);
    return HomePage;
    var _a, _b;
}());
...
var DetailPage = /** @class */ (function () {
    ...
    DetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-detail',template:/*ion-inline-start:"C:\Users\Kuya\Projects\planAhead\src\pages\detail\detail.html"*/'<!--\n  Generated template for the DetailPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>detail</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n</ion-content>\n'/*ion-inline-end:"C:\Users\Kuya\Projects\planAhead\src\pages\detail\detail.html"*/,
        }),
...
var CourseProvider = /** @class */ (function () {
    function CourseProvider(
        ...
        this.courses = this.coursesRef.snapshotChanges().pipe(Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["map"])(function (changes) {
            return changes.map(function (c) { return (__assign({ key: c.payload.key }, c.payload.val())); });
        }));
    }
    CourseProvider.prototype.getCourses = function () {
        return this.courses;
    };
    CourseProvider.prototype.addCourse = function (course) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_detail_detail__ = __webpack_require__(267);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_course_course__ = __webpack_require__(268);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_angularfire2__ = __webpack_require__(276);
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__providers_course_course__["a" /* CourseProvider */],
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\Kuya\Projects\planAhead\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"C:\Users\Kuya\Projects\planAhead\src\app\app.html"*/
        }),
